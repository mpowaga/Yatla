...
static void ___lambda4_ (Block5Data* _data5_);
...
static void __lambda10_ (Block4Data* _data4_, GtkEntryIconPosition pos, GdkEvent* event);
static void ___lambda10__gtk_entry_icon_press (GtkEntry* _sender, GtkEntryIconPosition p0, GdkEvent* p1, gpointer self);
...
YatlaLayout* yatla_layout_construct (GType object_type, YatlaDatabase* database) {
	...
	_tmp2_ = gee_tree_map_new (YATLA_TYPE_TASK, (GBoxedCopyFunc) g_object_ref, g_object_unref, GTK_TYPE_BOX, (GBoxedCopyFunc) g_object_ref, g_object_unref, ___lambda3__gcompare_data_func, g_object_ref (self), g_object_unref, NULL, NULL, NULL);
...
static void ___lambda4_ (Block5Data* _data5_) {
	...
	YatlaTaskPreferences* _tmp4_ = NULL;
	_data4_ = _data5_->_data4_;
	self = _data4_->self;
	_tmp0_ = self->_database;
	_tmp1_ = _data4_->sidebar;
	_tmp2_ = _data5_->task;
	_tmp3_ = _data4_->list_name;
	_tmp4_ = yatla_task_preferences_new (YATLA_TASK_PREFERENCES_TYPE_CHANGE, self, _tmp0_, _tmp1_, _tmp2_, _tmp3_);
	g_object_ref_sink (_tmp4_);
	task_preferences = _tmp4_;
...
static void __lambda10_ (Block4Data* _data4_, GtkEntryIconPosition pos, GdkEvent* event) {
	...
	YatlaTask* _tmp6_ = NULL;
	const gchar* _tmp7_ = NULL;
	YatlaTaskPreferences* _tmp8_ = NULL;
	YatlaTaskPreferences* _tmp9_ = NULL;
	self = _data4_->self;
	...
	_tmp4_ = _tmp3_;
	_tmp5_ = yatla_task_new (_tmp4_, NULL, NULL, FALSE);
	_tmp6_ = _tmp5_;
	_tmp7_ = _data4_->list_name;
	_tmp8_ = yatla_task_preferences_new (YATLA_TASK_PREFERENCES_TYPE_CREATE, self, _tmp0_, _tmp1_, _tmp6_, _tmp7_);
	g_object_ref_sink (_tmp8_);
	_tmp9_ = _tmp8_;
	_g_object_unref0 (_tmp6_);
	task_preferences = _tmp9_;
	gtk_widget_show ((GtkWidget*) task_preferences);
	_g_object_unref0 (task_preferences);
}
...
static void ___lambda11_ (Block6Data* _data6_) {
	...
	if (_tmp2_) {
		...
		gchar* _tmp14_ = NULL;
		gchar* _tmp15_ = NULL;
		YatlaTask* _tmp16_ = NULL;
		_tmp3_ = _data6_->checkBox;
		_tmp4_ = gtk_container_get_children ((GtkContainer*) _tmp3_);
		list = _tmp4_;
		_tmp5_ = list;
		_tmp6_ = g_list_nth_data (_tmp5_, (guint) 0);
		_tmp7_ = (GtkWidget*) _tmp6_;
		gtk_label_set_use_markup (G_TYPE_CHECK_INSTANCE_TYPE (_tmp7_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp7_) : NULL, TRUE);
		_tmp8_ = list;
		_tmp9_ = g_list_nth_data (_tmp8_, (guint) 0);
		_tmp10_ = (GtkWidget*) _tmp9_;
		_tmp11_ = _data6_->checkBox;
		_tmp12_ = gtk_button_get_label ((GtkButton*) _tmp11_);
		_tmp13_ = _tmp12_;
		_tmp14_ = g_strdup_printf ("<span strikethrough=\"true\" color=\"#b2b2b2\">%s</span>", _tmp13_);
		_tmp15_ = _tmp14_;
		gtk_label_set_markup (G_TYPE_CHECK_INSTANCE_TYPE (_tmp10_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp10_) : NULL, _tmp15_);
		_g_free0 (_tmp15_);
		_tmp16_ = _data6_->task;
		yatla_task_set_is_done (_tmp16_, TRUE);
		_g_list_free0 (list);
	} else {
		GList* list = NULL;
		...
		_tmp17_ = _data6_->checkBox;
		_tmp18_ = gtk_container_get_children ((GtkContainer*) _tmp17_);
		list = _tmp18_;
		_tmp19_ = list;
		_tmp20_ = g_list_nth_data (_tmp19_, (guint) 0);
		_tmp21_ = (GtkWidget*) _tmp20_;
		gtk_label_set_use_markup (G_TYPE_CHECK_INSTANCE_TYPE (_tmp21_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp21_) : NULL, FALSE);
		_tmp22_ = list;
		_tmp23_ = g_list_nth_data (_tmp22_, (guint) 0);
		_tmp24_ = (GtkWidget*) _tmp23_;
		_tmp25_ = _data6_->checkBox;
		_tmp26_ = gtk_button_get_label ((GtkButton*) _tmp25_);
		_tmp27_ = _tmp26_;
		gtk_label_set_label (G_TYPE_CHECK_INSTANCE_TYPE (_tmp24_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp24_) : NULL, _tmp27_);
		_tmp28_ = _data6_->task;
		yatla_task_set_is_done (_tmp28_, FALSE);
		_g_list_free0 (list);
	}
}
...
gboolean yatla_layout_load_layout (YatlaLayout* self, YatlaSidebar* sidebar, const gchar* list_name) {
	...
	GtkBox* _tmp163_ = NULL;
	GtkBox* _tmp164_ = NULL;
	guint _tmp165_ = 0U;
	GeeTreeMap* _tmp166_ = NULL;
	GeeCollection* _tmp167_ = NULL;
	GeeCollection* _tmp168_ = NULL;
	GeeCollection* _tmp169_ = NULL;
	gint _tmp170_ = 0;
	gint _tmp171_ = 0;
	GtkEntry* _tmp172_ = NULL;
	GeeMapIterator* map_iterator = NULL;
	GeeTreeMap* _tmp173_ = NULL;
	GeeMapIterator* _tmp174_ = NULL;
	...
	gtk_entry_set_icon_from_stock (_tmp20_, GTK_ENTRY_ICON_SECONDARY, "gtk-add");
	...
	while (TRUE) {
		...
		GtkBox* task_horizontal_box = NULL;
		GtkBox* _tmp145_ = NULL;
		GtkButton* task_preferences_button = NULL;
		...
		GtkCheckButton* _tmp153_ = NULL;
		GtkBox* _tmp154_ = NULL;
		GtkButton* _tmp155_ = NULL;
		GeeTreeMap* _tmp156_ = NULL;
		YatlaTask* _tmp157_ = NULL;
		...
		_data5_->task = _tmp100_;
		_tmp101_ = _data5_->task;
		_tmp102_ = task_id;
		...
		if (_tmp116_) {
			...
			gchar* _tmp128_ = NULL;
			gchar* _tmp129_ = NULL;
			YatlaTask* _tmp130_ = NULL;
			_tmp117_ = checkBox;
			_tmp118_ = gtk_container_get_children ((GtkContainer*) _tmp117_);
			list = _tmp118_;
			_tmp119_ = list;
			_tmp120_ = g_list_nth_data (_tmp119_, (guint) 0);
			_tmp121_ = (GtkWidget*) _tmp120_;
			gtk_label_set_use_markup (G_TYPE_CHECK_INSTANCE_TYPE (_tmp121_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp121_) : NULL, TRUE);
			_tmp122_ = list;
			_tmp123_ = g_list_nth_data (_tmp122_, (guint) 0);
			_tmp124_ = (GtkWidget*) _tmp123_;
			_tmp125_ = checkBox;
			_tmp126_ = gtk_button_get_label ((GtkButton*) _tmp125_);
			_tmp127_ = _tmp126_;
			_tmp128_ = g_strdup_printf ("<span strikethrough=\"true\" color=\"#b2b2b2\">%s</span>", _tmp127_);
			_tmp129_ = _tmp128_;
			gtk_label_set_markup (G_TYPE_CHECK_INSTANCE_TYPE (_tmp124_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp124_) : NULL, _tmp129_);
			_g_free0 (_tmp129_);
			_tmp130_ = _data5_->task;
			yatla_task_set_is_done (_tmp130_, TRUE);
			_g_list_free0 (list);
		} else {
			GList* list = NULL;
			...
			GList* _tmp132_ = NULL;
			GList* _tmp133_ = NULL;
			gconstpointer _tmp134_ = NULL;
			GtkWidget* _tmp135_ = NULL;
			GList* _tmp136_ = NULL;
			gconstpointer _tmp137_ = NULL;
			GtkWidget* _tmp138_ = NULL;
			GtkCheckButton* _tmp139_ = NULL;
			const gchar* _tmp140_ = NULL;
			const gchar* _tmp141_ = NULL;
			YatlaTask* _tmp142_ = NULL;
			_tmp131_ = checkBox;
			_tmp132_ = gtk_container_get_children ((GtkContainer*) _tmp131_);
			list = _tmp132_;
			_tmp133_ = list;
			_tmp134_ = g_list_nth_data (_tmp133_, (guint) 0);
			_tmp135_ = (GtkWidget*) _tmp134_;
			gtk_label_set_use_markup (G_TYPE_CHECK_INSTANCE_TYPE (_tmp135_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp135_) : NULL, FALSE);
			_tmp136_ = list;
			_tmp137_ = g_list_nth_data (_tmp136_, (guint) 0);
			_tmp138_ = (GtkWidget*) _tmp137_;
			_tmp139_ = checkBox;
			_tmp140_ = gtk_button_get_label ((GtkButton*) _tmp139_);
			_tmp141_ = _tmp140_;
			gtk_label_set_label (G_TYPE_CHECK_INSTANCE_TYPE (_tmp138_, GTK_TYPE_LABEL) ? ((GtkLabel*) _tmp138_) : NULL, _tmp141_);
			_tmp142_ = _data5_->task;
			yatla_task_set_is_done (_tmp142_, FALSE);
			_g_list_free0 (list);
		}
		_tmp143_ = checkBox;
		_tmp144_ = task_note;
		gtk_widget_set_tooltip_text ((GtkWidget*) _tmp143_, _tmp144_);
		_tmp145_ = (GtkBox*) gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0);
		g_object_ref_sink (_tmp145_);
		task_horizontal_box = _tmp145_;
		_tmp146_ = (GtkButton*) gtk_button_new_from_icon_name ("gtk-edit", GTK_ICON_SIZE_SMALL_TOOLBAR);
		g_object_ref_sink (_tmp146_);
		task_preferences_button = _tmp146_;
		_tmp147_ = task_preferences_button;
		gtk_button_set_relief (_tmp147_, GTK_RELIEF_NONE);
		_tmp148_ = task_preferences_button;
		gtk_button_set_focus_on_click (_tmp148_, FALSE);
		_tmp149_ = task_preferences_button;
		g_object_set (_tmp149_, "xalign", 1.0f, NULL);
		_tmp150_ = task_preferences_button;
		gtk_widget_set_size_request ((GtkWidget*) _tmp150_, 20, 20);
		_tmp151_ = task_preferences_button;
		g_signal_connect_data (_tmp151_, "clicked", (GCallback) ____lambda4__gtk_button_clicked, block5_data_ref (_data5_), (GClosureNotify) block5_data_unref, 0);
		_tmp152_ = task_horizontal_box;
		_tmp153_ = checkBox;
		gtk_box_pack_start (_tmp152_, (GtkWidget*) _tmp153_, TRUE, TRUE, (guint) 0);
		_tmp154_ = task_horizontal_box;
		_tmp155_ = task_preferences_button;
		gtk_box_pack_end (_tmp154_, (GtkWidget*) _tmp155_, TRUE, TRUE, (guint) 0);
		_tmp156_ = self->tasks;
		_tmp157_ = _data5_->task;
		_tmp158_ = task_horizontal_box;
		gee_abstract_map_set ((GeeAbstractMap*) _tmp156_, _tmp157_, _tmp158_);
		_tmp159_ = self->_tasks_box;
		_tmp160_ = task_horizontal_box;
		gtk_box_pack_start (_tmp159_, (GtkWidget*) _tmp160_, TRUE, TRUE, (guint) 0);
		_tmp161_ = task_index;
		task_index = _tmp161_ + 1;
		_g_object_unref0 (task_preferences_button);
		_g_object_unref0 (task_horizontal_box);
	...
	_tmp162_ = self->_top_box1;
	gtk_layout_put ((GtkLayout*) self, (GtkWidget*) _tmp162_, 25, 20);
	_tmp163_ = self->_top_box2;
	gtk_layout_put ((GtkLayout*) self, (GtkWidget*) _tmp163_, 20, 40);
	_tmp164_ = self->_tasks_box;
	gtk_layout_put ((GtkLayout*) self, (GtkWidget*) _tmp164_, 20, 100);
	_tmp165_ = the_longest_task;
	g_object_set ((GtkLayout*) self, "width", 65 + (_tmp165_ * 7), NULL);
	_tmp166_ = self->tasks;
	_tmp167_ = gee_abstract_map_get_values ((GeeMap*) _tmp166_);
	_tmp168_ = _tmp167_;
	_tmp169_ = _tmp168_;
	_tmp170_ = gee_collection_get_size (_tmp169_);
	_tmp171_ = _tmp170_;
	g_object_set ((GtkLayout*) self, "height", (guint) (100 + (_tmp171_ * 30)), NULL);
	_g_object_unref0 (_tmp169_);
	gtk_widget_show_all ((GtkWidget*) self);
	_tmp172_ = self->new_task_entry;
	g_signal_connect_data (_tmp172_, "icon-press", (GCallback) ___lambda10__gtk_entry_icon_press, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
	_tmp173_ = self->tasks;
	_tmp174_ = gee_abstract_map_map_iterator ((GeeAbstractMap*) _tmp173_);
	map_iterator = _tmp174_;
	while (TRUE) {
		Block6Data* _data6_;
		...
		GList* _tmp180_ = NULL;
		GList* _tmp181_ = NULL;
		gconstpointer _tmp182_ = NULL;
		GtkWidget* _tmp183_ = NULL;
		GtkCheckButton* _tmp184_ = NULL;
		GtkCheckButton* _tmp185_ = NULL;
		GeeMapIterator* _tmp186_ = NULL;
		gpointer _tmp187_ = NULL;
		GtkCheckButton* _tmp188_ = NULL;
		_data6_ = g_slice_new0 (Block6Data);
		_data6_->_ref_count_ = 1;
		_data6_->_data4_ = block4_data_ref (_data4_);
		_tmp175_ = map_iterator;
		_tmp176_ = gee_map_iterator_next (_tmp175_);
		if (!_tmp176_) {
			block6_data_unref (_data6_);
			_data6_ = NULL;
			break;
		}
		_tmp177_ = map_iterator;
		_tmp178_ = gee_map_iterator_get_value (_tmp177_);
		_tmp179_ = (GtkBox*) _tmp178_;
		_tmp180_ = gtk_container_get_children ((GtkContainer*) _tmp179_);
		_tmp181_ = _tmp180_;
		_tmp182_ = g_list_nth_data (_tmp181_, (guint) 0);
		_tmp183_ = (GtkWidget*) _tmp182_;
		_tmp184_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp183_, GTK_TYPE_CHECK_BUTTON) ? ((GtkCheckButton*) _tmp183_) : NULL);
		_tmp185_ = _tmp184_;
		_g_list_free0 (_tmp181_);
		_g_object_unref0 (_tmp179_);
		_data6_->checkBox = _tmp185_;
		_tmp186_ = map_iterator;
		_tmp187_ = gee_map_iterator_get_key (_tmp186_);
		_data6_->task = (YatlaTask*) _tmp187_;
		_tmp188_ = _data6_->checkBox;
		g_signal_connect_data ((GObject*) _tmp188_, "notify::active", (GCallback) ____lambda11__g_object_notify, block6_data_ref (_data6_), (GClosureNotify) block6_data_unref, 0);
		block6_data_unref (_data6_);
		_data6_ = NULL;
	}
	result = TRUE;
