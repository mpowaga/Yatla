...
gboolean yatla_layout_load_layout (YatlaLayout* self, YatlaSidebar* sidebar, const gchar* list_name) {
	...
	while (TRUE) {
		...
		GeeTreeMap* _tmp109_ = NULL;
		YatlaTask* _tmp110_ = NULL;
		GtkCheckButton* _tmp111_ = NULL;
		GtkBox* _tmp112_ = NULL;
		GtkCheckButton* _tmp113_ = NULL;
		gint _tmp114_ = 0;
		...
		_tmp103_ = task_name;
		_tmp104_ = (GtkCheckButton*) gtk_check_button_new_with_label (_tmp103_);
		g_object_ref_sink (_tmp104_);
		checkBox = _tmp104_;
		_tmp105_ = checkBox;
		_tmp106_ = task_is_done;
		gtk_toggle_button_set_active ((GtkToggleButton*) _tmp105_, _tmp106_);
		_tmp107_ = checkBox;
		gtk_widget_set_has_tooltip ((GtkWidget*) _tmp107_, TRUE);
		_tmp108_ = checkBox;
		g_signal_connect_data ((GtkWidget*) _tmp108_, "query-tooltip", (GCallback) ____lambda4__gtk_widget_query_tooltip, block5_data_ref (_data5_), (GClosureNotify) block5_data_unref, 0);
		_tmp109_ = self->tasks;
		_tmp110_ = task;
		_tmp111_ = checkBox;
		gee_abstract_map_set ((GeeAbstractMap*) _tmp109_, _tmp110_, _tmp111_);
		_tmp112_ = self->_tasks_box;
		_tmp113_ = checkBox;
		gtk_box_pack_start (_tmp112_, (GtkWidget*) _tmp113_, TRUE, TRUE, (guint) 0);
		_tmp114_ = task_index;
		task_index = _tmp114_ + 1;
	...
	_tmp115_ = self->_top_box1;
	gtk_layout_put ((GtkLayout*) self, (GtkWidget*) _tmp115_, 25, 20);
	_tmp116_ = self->_top_box2;
	gtk_layout_put ((GtkLayout*) self, (GtkWidget*) _tmp116_, 20, 40);
	_tmp117_ = self->_tasks_box;
	gtk_layout_put ((GtkLayout*) self, (GtkWidget*) _tmp117_, 20, 100);
	_tmp118_ = self->tasks;
	...
	_tmp123_ = _tmp122_;
	g_object_set ((GtkLayout*) self, "height", (guint) (100 + (_tmp123_ * 30)), NULL);
	_g_object_unref0 (_tmp121_);
	gtk_widget_show_all ((GtkWidget*) self);
	_tmp124_ = self->new_task_entry;
	g_signal_connect_data (_tmp124_, "icon-press", (GCallback) ___lambda5__gtk_entry_icon_press, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
	_tmp125_ = self->tasks;
	_tmp126_ = gee_abstract_map_map_iterator ((GeeAbstractMap*) _tmp125_);
	map_iterator = _tmp126_;
	while (TRUE) {
		Block6Data* _data6_;
		GeeMapIterator* _tmp127_ = NULL;
		...
		_tmp128_ = gee_map_iterator_next (_tmp127_);
		if (!_tmp128_) {
			block6_data_unref (_data6_);
			_data6_ = NULL;
			break;
		}
		_tmp129_ = map_iterator;
		_tmp130_ = gee_map_iterator_get_value (_tmp129_);
		_data6_->checkBox = (GtkCheckButton*) _tmp130_;
		_tmp131_ = map_iterator;
		_tmp132_ = gee_map_iterator_get_key (_tmp131_);
		_data6_->task = (YatlaTask*) _tmp132_;
		_tmp133_ = _data6_->checkBox;
		g_signal_connect_data ((GObject*) _tmp133_, "notify::active", (GCallback) ____lambda11__g_object_notify, block6_data_ref (_data6_), (GClosureNotify) block6_data_unref, 0);
		block6_data_unref (_data6_);
		_data6_ = NULL;
	}
	result = TRUE;
